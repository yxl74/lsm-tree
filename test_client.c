...
int main(){
	...
	pthread_create(&c4, NULL, put, (void*) dp1);
	pthread_create(&c5, NULL, put, (void*) dp1);
	pthread_create(&c6, NULL, put, (void*) dp1);
	pthread_create(&c7, NULL, get, (void*) key1);
